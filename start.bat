...
title HP App - Start + Install

cd /d "%~dp0"

:: ==========================================================
:: START.BAT UNIFICADO PARA WINDOWS
...
> "%LOGFILE%" echo =========================================
>> "%LOGFILE%" echo HP App Windows unified start/install log
...
start "Abrir HP App" cmd /c "timeout /t 5 /nobreak >nul && start "" "%APP_URL%""
